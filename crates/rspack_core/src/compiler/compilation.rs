...
impl Compilation {
  ...
  #[instrument("Compilation:process_runtime_requirements", skip_all)]
  ...
  #[instrument("Compilation:create_hash", skip_all)]
  ...
  // #[instrument("Compilation:create_runtime_module_hash", skip_all)]
